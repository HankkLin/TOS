...
### 階段 1：原型開發（Prototype）- 3 個月

**技術目標：**
- 搭建 Unity 專案框架（URP + 版本控制）
- 實現基礎 Cel-shading Shader
- 完成 3D 轉珠盤核心機制（拖曳、消除、連鎖）
- 建立魔方 UI 基礎旋轉系統
- 簡易戰鬥系統（1 個角色 vs 1 個敵人）
...
### 階段 2：垂直切片（Vertical Slice / Alpha）- 6 個月

**技術目標：**
- 完整 Cel-shading 管線（描邊、邊緣光、陰影）
- 粒子系統與特效完整實現
- 魔方 UI 六面功能完成
- 完整戰鬥系統（技能、BUFF/DEBUFF、AI）
- 跨平台輸入抽象層
- 存檔系統（本地 + 雲端同步）
...
- 無障礙功能完成
- 動態畫質調整系統
- 完整的分析與監控系統（Crashlytics, Analytics）
